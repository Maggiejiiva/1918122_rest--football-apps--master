const ApiKey = "30491279e4e8470bb11e804fc74c617a";
                    ...
                    <div class="col s6">
                        <div class="card purple darken-3">
                            <div class="card-content white-text">
                                ...
                                <span class="card-title" style="font-weight:bold;">${resJson.tla}</span>
                                <br>
                                <p>Berdiri : ${resJson.founded}</p>
                                <br>
                                <p>Markas Utama : ${resJson.venue}.</p>
                                <br>
                                <p>Warna Tim : ${resJson.clubColors}</p>
                                <br>
                                <p class="left-align">Alamat : ${resJson.address}</p>
                                <br>
                                <p class="left-align">Laman Web : ${resJson.website}</p>
                                <br>
                                <font class="left-align">Telepon : ${resJson.phone}</font> | 
                                <font class="right-align">Surel : ${resJson.email}</font>
                            </div>
                        </div>
                    </div>
                </div>
